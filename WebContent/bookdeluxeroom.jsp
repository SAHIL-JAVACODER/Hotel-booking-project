...
%>	
		...
		<div id="wrapper" class="container">
			...
			<section class="main-content">				
				...
				<form action="bookdeluxeroom1.jsp" method="post" name="">
				<tr>
				...
				<tr>
					<td align="center"><strong>Select the no.of deluxe rooms : </strong></td>
					<td align="center"><select size="1" name="noder">
