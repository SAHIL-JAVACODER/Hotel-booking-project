		...
		<div id="wrapper" class="container">
			...
			<section class="main-content">				
	     		...
	     		<tr>
		  		...
		  		<% 
					...
					String email=request.getParameter("ea");
		  			int nodor=Integer.parseInt(request.getParameter("nodor1"));
				...
				<tr>
					...
					<td align="center"><input type="text" name="nosr1" value=<%=nodor %> readonly></td>
				</tr>
				<tr>
				...
				<tr>
					<td align="center">
							...
							<input type="hidden" name="typeofroom" value=<%=rs.getString("typeofroom2")%>>
							<input type="hidden" name="poroom" value=<%=rs.getDouble("podoubleroom")%>>
