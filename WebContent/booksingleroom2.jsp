			...
			<section class="main-content">				
	     		...
	     		<tr>
		  		...
		  		<% 
					...
					String email=request.getParameter("ea");
		  			int nosr=Integer.parseInt(request.getParameter("nosr1"));
				...
				<tr>
					<td align="center">
							...
							<input type="hidden" name="typeofroom" value=<%=rs.getString("typeofroom1")%>>
							<input type="hidden" name="poroom" value=<%=rs.getDouble("posingleroom")%>>
