				...
				<div class="row">				
					<div class="span5">
						<div>
							...
							<p><strong>Phone:</strong>&nbsp;(033) 2456-7890<br>
							<strong>Fax:</strong>&nbsp;+04 (033) 2456-7890<br>
							<strong>Email:</strong>&nbsp;<a href="#">letsgo_in@yahoo.com</a>								
							</p>
							<br/>
							<h5>OFFICE IN INDIA</h5>
							<p><strong>Phone:</strong>&nbsp;(033) 2023-1125<br>
							<strong>Fax:</strong>&nbsp;+04 (033) 2023-1145<br>
							<strong>Email:</strong>&nbsp;<a href="#">letsgo_in@yahoo.com</a>					
							</p>
						</div>
					</div>
					<div class="span7">
						<h5>For any kind of queries & inconvenience dont forget to get in touch with us ! We would be more than happy to help u. You could also reach us in our mentioned addresses given alongside.Do have a look. Happy Booking!</h5><br>
						<form method="post" action="#">
							<fieldset>
								...
								<div class="clearfix">
									<label for="email"><span><strong>Email:</strong></span></label>
									<div class="input">
								...
								<div class="clearfix">
									<label for="message"><span><strong>Message:</strong></span></label>
									<div class="input">
								...
								<div class="actions">
                                    ...
                                    &nbsp;&nbsp;<button tabindex="3" type="reset" class="btn btn-inverse">Cancel</button>
								</div>
							</fieldset>
						</form>
					</div>				
