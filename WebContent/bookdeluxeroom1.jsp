...
<div id="top-bar" class="container">
		...
		<div id="wrapper" class="container">
			...
			<section class="main-content">				
				...
				<form action="bookdeluxeroom2.jsp" method="post" name="">
				<tr>
				...
				<% 
		  			int noder=Integer.parseInt(request.getParameter("noder"));
				...
				<tr>
					...
					<td align="center"><input type="text" name="noder1" value=<%=noder %> readonly></td>
				</tr>
				<tr>
