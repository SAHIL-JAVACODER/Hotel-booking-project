...
<script type="text/javascript">
	function check() 
	{
	  ...
	  {
		document.getElementById("non1").value = noofdays;
	  }
	}		
</script>
<style>
...
<%
		...
		{ 	
		    ...
		    String query="SELECT id,place,name,typeofroom2,podoubleroom,image FROM ohbhotels WHERE id='"+hid+"' ";
...
<div id="top-bar" class="container">
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" src="themes/images/pageBanner.jpg" alt="New products" >
				<h4><span>Check all details entered</span></h4>
			</section>
			...
			<section class="main-content">				
				...
				<form action="bookdoubleroom2.jsp" method="post" name="">
				<tr>
		  		...
		  		<tr>
		  			...
		  			<td align="center">
		  				<strong><%=rs.getString("typeofroom2")%></strong>
	     			</td>
	     		</tr>
	     		<tr>
	     			...
	     			<td align="center">
						...
						<strong>Rs. <%=rs.getDouble("podoubleroom")%> for 1 night</strong>
					</td>
		  		</tr>
		  		<tr>
				...
				<% 
		  			int nodor=Integer.parseInt(request.getParameter("nodor"));
		    		int nog=Integer.parseInt(request.getParameter("nog"));
		    		String noguest=request.getParameter("noguest");
		    		//out.print(noguest);
		    		session.setAttribute("guestname",noguest);
		    		String checkin=request.getParameter("checkin");
		    		String checkout=request.getParameter("checkout");
		    		double podor=rs.getDouble("podoubleroom");
		    	%>
				<tr>
					<td align="center"><strong>No.of double rooms : </strong></td>
					<td align="center"><input type="text" name="nodor1" value=<%=nodor %> readonly></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center"><input type="text" id="non1" name="non1" readonly></td>
				</tr>
				<script type="text/javascript">
					check(); 
				</script>
