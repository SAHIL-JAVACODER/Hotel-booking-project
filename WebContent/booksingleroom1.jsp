...
<div id="top-bar" class="container">
		...
		<div id="wrapper" class="container">
			...
			<section class="main-content">				
				...
				<form action="booksingleroom2.jsp" method="post" name="">
				<tr>
				...
				<% 
		  			int nosr=Integer.parseInt(request.getParameter("nosr"));
		    		...
		    		double posr=rs.getDouble("posingleroom");
		    	%>
				<tr>
					<td align="center"><strong>No.of single rooms : </strong></td>
					<td align="center"><input type="text" name="nosr1" value=<%=nosr %> readonly></td>
				</tr>
				<tr>
