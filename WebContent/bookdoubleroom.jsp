...
%>	
		...
		<div id="wrapper" class="container">
			...
			<section class="main-content">				
				...
				<form action="bookdoubleroom1.jsp" method="post" name="">
				<tr>
				...
				<tr>
					<td align="center"><strong>Select the no.of double rooms : </strong></td>
					<td align="center"><select size="1" name="nodor">
